 ...
 * 
 */
@WebServiceClient(name = "userService", targetNamespace = "http://service.soap.bsu.by/", wsdlLocation = "http://localhost:8088/soap/userService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://service.soap.bsu.by/", "userService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8088/soap/userService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://service.soap.bsu.by/", "userServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.soap.bsu.by/", "userServicePort"), UserService.class, features);
    }
